...
console.log("Keep running and coding!");`}
      ...
      {/* 駅伝ロゴの背景イメージ（回転・濃く表示） */}
      <div className="absolute bottom-20 right-4 sm:right-20 z-0 opacity-60 animate-spin-slower">
        <Image src="/1770477.png" alt="Ekiden Logo" width={200} height={200} />
      </div>

      {/* マイクラロゴの背景イメージ（Developmentカード付近に移動） */}
      <div className="absolute top-[260px] left-6 sm:left-[calc(50%-460px)] z-0 opacity-40">
        <Image src="/minecraft-logo.png" alt="Minecraft Logo" width={120} height={120} />
      </div>

      <h1 className="relative z-10 text-4xl sm:text-5xl font-bold bg-gradient-to-r from-pink-400 via-pink-300 to-pink-500 bg-clip-text text-transparent mb-4 drop-shadow-lg">
        Introduction
      </h1>
      <div className="relative z-10 w-16 h-1 bg-pink-400 rounded-full mb-8"></div>

      <div className="relative z-10 text-base sm:text-lg text-center text-pink-100 max-w-2xl mb-16 leading-loose space-y-6 px-4">
        <p>
      ...
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 w-full max-w-4xl px-4">
        <div className="bg-white/10 border border-white/20 p-5 sm:p-6 rounded-lg shadow-md hover:bg-white/20 transition-all">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold">Development</h2>
          </div>
        ...
        <div className="bg-white/10 border border-white/20 p-5 sm:p-6 rounded-lg shadow-md hover:bg-white/20 transition-all">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold">Server Management</h2>
          </div>
          <p className="text-pink-100 text-sm">
        ...
        <div className="bg-white/10 border border-white/20 p-5 sm:p-6 rounded-lg shadow-md hover:bg-white/20 transition-all">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold">Running</h2>
          </div>
          <p className="text-pink-100 text-sm">
        ...
        <div className="bg-white/10 border border-white/20 p-5 sm:p-6 rounded-lg shadow-md hover:bg-white/20 transition-all">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold">Teamwork</h2>
          </div>
          <p className="text-pink-100 text-sm">
